...
- [BGP in the Data Center (PDF)](./papers/bgp-in-the-data-center.pdf)

### Building a Billion User Load Balancer

- [USENIX Presentation](https://www.usenix.org/conference/lisa16/conference-program/presentation/shuff)

### QoS (Quality of Service)

- [Linux Traffic Control Guide](https://netbeez.net/blog/how-to-use-the-linux-traffic-control/)
- [HTB User Guide](http://luxik.cdi.cz/~devik/qos/htb/manual/userg.htm)
- [Token Bucket Explanation](https://intronetworks.cs.luc.edu/current/html/tokenbucket.html)
- [Fair Queuing Explanation](https://intronetworks.cs.luc.edu/current/html/fairqueuing.html)

### eBPF (Extended Berkeley Packet Filter)

- [ACM Research Paper](https://dl.acm.org/doi/10.1145/3281411.3281443)
- [Brendan Gregg's Blog on eBPF Tracing](https://www.brendangregg.com/blog/2019-01-01/learn-ebpf-tracing.html)
